...
CODEX_RUBY_BUNDLE=source ~/.zshrc && mkdir -p "$(DISABLE_LIVERELOAD) $(CODEX_BUNDLE_USER_HOME)" "$(BUNDLE_PATH)" "$(CODEX_RUBOCOP_CACHE_ROOT)" && BUNDLE_USER_HOME="$(CODEX_BUNDLE_USER_HOME)" BUNDLE_PATH="$(BUNDLE_PATH)" RUBOCOP_CACHE_ROOT="$(CODEX_RUBOCOP_CACHE_ROOT)" bundle exec
