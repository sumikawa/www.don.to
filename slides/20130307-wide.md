...
- Only ```file_copy``` supports progree bar
...
![status](https://cacoo.com/diagrams/PqSPjH8mrndTotT1-A9CC2.png)
...
- No binding mechanism between pre-UPGRADE and post-UPGRADE in server side
  ...
  - Can snoop it after the valid authorization

![](https://cacoo.com/diagrams/PqSPjH8mrndTotT1-698AD.png)
